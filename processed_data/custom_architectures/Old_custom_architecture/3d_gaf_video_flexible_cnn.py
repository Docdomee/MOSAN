...
def build_model(input_shape, num_classes, params):
    """
    Flexible 3D GAF Video CNN that handles varying temporal dimensions
    Uses 2D convolutions for spatial features + temporal aggregation
    """
    ...
    # First process spatial features within each time segment
