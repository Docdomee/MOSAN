...
def build_model(input_shape, num_classes, params):
    ...
    genotype = {'normal': [['skip_connect', 0], ['skip_connect', 1], ['skip_connect', 2], ['skip_connect', 0], ['skip_connect', 0], ['skip_connect', 2], ['avg_pool_3x3', 2], ['dil_conv_3x3', 1]], 'normal_concat': [2, 3, 4, 5], 'reduce': [['max_pool_3x3', 0], ['max_pool_3x3', 1], ['max_pool_3x3', 0], ['max_pool_3x3', 2], ['max_pool_3x3', 0], ['avg_pool_3x3', 1], ['avg_pool_3x3', 0], ['dil_conv_5x5', 2]], 'reduce_concat': [2, 3, 4, 5]}
