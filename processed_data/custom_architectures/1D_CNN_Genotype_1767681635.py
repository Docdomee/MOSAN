...
def build_model(input_shape, num_classes, params):
    ...
    # FIX: Ensure channels are even for FactorizedReduce (skip_connect with stride=2)
    if c_curr % 2 != 0:
        c_curr += 1
    layers_count = params.get('layers', 8)
    genotype = {'normal': [['dil_conv_5x5', 1], ['dil_conv_3x3', 0], ['dil_conv_3x3', 1], ['dil_conv_5x5', 2], ['avg_pool_3x3', 0], ['dil_conv_5x5', 2], ['sep_conv_5x5', 3], ['dil_conv_3x3', 1]], 'normal_concat': [2, 3, 4, 5], 'reduce': [['sep_conv_3x3', 1], ['avg_pool_3x3', 0], ['dil_conv_5x5', 2], ['skip_connect', 0], ['dil_conv_5x5', 3], ['dil_conv_5x5', 0], ['sep_conv_5x5', 3], ['sep_conv_5x5', 0]], 'reduce_concat': [2, 3, 4, 5]}
